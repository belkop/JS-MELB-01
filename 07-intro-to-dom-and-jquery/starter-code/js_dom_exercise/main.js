...
- Change the value of the element with the id of 'name' to be whatever the user
  inputs via a prompt box when page first loads.
- When the user clicks the "#new-thing-button" button, add whatever is in the
  input box to the "#fav-list" list.
