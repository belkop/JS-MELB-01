...
Another important trait of functions is that they are similar to objects or strings, in terms of what you can do with them. Functions can be passed into other functions as an argument, and they can also be used like any other object we've been working with.
...
* A name
* An optional list of parameters (i.e., the names of arguments to be "passed" into the function, i.e. the information the function will use); this is defined by the parenthesis before the opening curly brace
...
> __Note:__ Why do you think writing such specific functions is a bad idea. What happens to the above program structure if it has 1,000 users. If we have to write 1,000 different functions, is this a scalable and maintainable program?
...
Before you write a line of JavaScript, you're in what we call the `Global Scope`. When a variable is declared outside a function, it is public —-referred to as GLOBAL-— and has global scope. Any script or function on the page can then reference this variable.
