...
//    list out at least two properties and behaviors that it would make sense
//    for that abstraction to have. Below is an example - please write your
...
//    values for each of its properties.
  ...
  // 'Owner'
  // Description: We are making an app for a veterinary clinic - it manages pets'
  // vaccinations.
  // Every 'owner' has:
  // - a name
  // - an address
...
//    The constructor function should be responseible for setting the values of
//    `name`, `species`, `breed`, and `noise`. The constructor function should
//    also give each pet a method called `makeNoise`, which behaves as described
//    in Q3.
